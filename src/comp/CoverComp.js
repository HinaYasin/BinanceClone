	...
	return (
		<div className="cover" >
			...
			<div className="cover_top">
				...
				<Link to='/trade-crypto-futures' style={{ textDecoration: 'none' }}><button className="explorebtn">Explore</button></Link>
				...
				<div className="currencies">
					...
					<div className="newbtn">
						...
						<Link to='/otc-trading-history' style={{ textDecoration: 'none' }}><button className="explorebtn secondexp">Explore</button></Link>
				...
				<div className="tradebitcoindiv">
					<div className="tradeall">
						...
						<Link to='/trade-crypto-futures' style={{ textDecoration: 'none' }}><button className="explorebtn secondexp" id="tradeexp">Explore</button></Link>
				...
				<div className="iphonewallpaper">
					...
					<div className="tradeall iphn" id="iphnid">
						<p className="trtext">New: Trade Bitcoin for free</p>
						<p className="trsmalltext">0 trading fee on selected Bitcoin (BTC) spot trading pairs now</p>
						<Link to='/trade-crypto-futures' style={{ textDecoration: 'none' }}><button className="explorebtn secondexp" id="trbtn">Explore</button></Link>
					</div>
				...
				<div className="diveintodiv">
					<div className="diveintoparent">
						...
						<Link to='/nftLandingPage' style={{ textDecoration: 'none' }}><button className="explorebtn secondexp" id="nftexp">Explore</button></Link>
					</div>
					<div>
				...
				<div className="earnusingdiv">
					...
					<div className="earnusingtext">
						...
						<Link to='/swap' style={{ textDecoration: 'none' }}><button className="explorebtn secondexp btnexp">Explore</button></Link>
					</div>
				</div>
				<div className="carddiv">
					...
					<div className="opentextdiv">
						...
						<Link to='/nftLandingPage' style={{ textDecoration: 'none' }}><button className="explorebtn secondexp" id="openexp" >Explore</button></Link>
					</div>
				</div>
			...
			<div className="faq_bottom">
				...
				<Link to='/welcome-login' style={{ textDecoration: 'none' }}><button className="signupbtn">Sign Up</button></Link>
